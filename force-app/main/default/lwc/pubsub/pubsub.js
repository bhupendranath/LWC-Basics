...
/***
 * Subscribe("pubsubEvent1", function(message){
 * console.log(message);
 * })
 * This will log the message when the event "pubsubEvent1" is published.
 * And will store the callback in the store object as below
 * store = {
 *   "pubsubEvent1":function(message){ 
 *      console.log(message);})
 *     }
 * Note: In Store object, the key is the <<event name>> and the value is a <<Set of callbacks>>.
 */
